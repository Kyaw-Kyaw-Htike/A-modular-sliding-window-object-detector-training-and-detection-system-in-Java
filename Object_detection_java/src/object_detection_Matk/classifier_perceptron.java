...
public class classifier_perceptron extends classifier_Base{
     ...
     */
    @Override
    public void train(List<Matk> feats, List<Integer> labels_)
    {
        ...
        for (int i = 0; i < nepochs; i++)
        {
            ...
            for (int j = 0; j < niters; j++)
            {
                ...
                Matk featVec = feats.get(idx_picked);
